        ...
        describe("command line interface", function () {
            it("has a command line interface", function (done) {
                childProcess.exec(__dirname + "/../../bin/exerciser test/integration/urls.txt localhost:9999 3 1", function (error) {
                    ...
                    requests.should.equal(3);
                    done();
                });
            });
            it("works with a single url", function (done) {
                childProcess.exec(__dirname + "/../../bin/exerciser / localhost:9999 3 1", function (error) {
                    assert.ifError(error);
                    requests.should.equal(3);
                    done();
                });
            });
            it("can write json file", function (done) {
            ...
            it("returns non zero for error", function (done) {
                statusCodes = [500];
            ...
            it("is usable as a lib", function (done) {
